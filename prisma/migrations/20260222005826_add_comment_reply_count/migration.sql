...
INSERT INTO "new_Comment" ("createdAt", "docId", "driveCreatedAt", "driveModifiedAt", "googleCommentId", "iParticipated", "id", "isMine", "resolved", "status", "updatedAt") SELECT "createdAt", "docId", "driveCreatedAt", "driveModifiedAt", "googleCommentId", "iParticipated", "id", "isMine", "resolved", "status", "updatedAt" FROM "Comment";
DROP TABLE "Comment";
