...
- [ ] Unread column reads "unread / total": "1 / 1" for an unread zero-reply thread, no count once read, entirely blank for a read single-message thread, and the three parts line up down the table
