...
(function(){
  ...
  var svg='<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#5f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><line x1="10" y1="9" x2="8" y2="9"/></svg>';
  link.innerHTML=svg;
  link.onmouseenter=function(){this.querySelector('svg').setAttribute('stroke','#1a73e8')};
  link.onmouseleave=function(){this.querySelector('svg').setAttribute('stroke','#5f6368')};
